...
#include "../massenger_client/addnewfriend.h"
...
void AddNewFriend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddNewFriend *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onListallUsersClicked((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject AddNewFriend::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_AddNewFriend.data,
    qt_meta_data_AddNewFriend,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddNewFriend::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddNewFriend.stringdata0))
