...
#include "../messenger_client/setusername.h"
...
QT_MOC_LITERAL(1, 12, 26), // "on_accept_username_clicked"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 16) // "QAbstractButton*"

    },
    "SetUsername\0on_accept_username_clicked\0"
    "\0QAbstractButton*"
};
...
void SetUsername::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SetUsername *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_accept_username_clicked((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject SetUsername::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_SetUsername.data,
    qt_meta_data_SetUsername,
    qt_static_metacall,
    nullptr,
    nullptr
} };
